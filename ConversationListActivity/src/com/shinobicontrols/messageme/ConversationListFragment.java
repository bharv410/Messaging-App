...
public class ConversationListFragment extends ListFragment implements Observer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        conversationArrayAdapter = new ArrayAdapter<Conversation>(
                ...
                android.R.id.text1,
                DataProvider.getInstance().getConversations(getActivity()));
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(DataProvider.getInstance().getConversations(getActivity()).get(position).getSender());
    }
